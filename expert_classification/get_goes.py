...
def get_GOES_file_loc(curr_time, mode, sat_num):
    ...
    if C14_fn:
        ...
        C01_prefix = C14_prefix.replace('C14', 'C01')
        C02_prefix = C14_prefix.replace('C14', 'C02')
        C03_prefix = C14_prefix.replace('C14', 'C03')
        ...
        try:
            ...
            C01_fn = client.list_objects_v2(Bucket='noaa-goes{}'.format(sat_num), Prefix=C01_prefix)['Contents'][0]['Key']
            ...
            return [C14_fn, C15_fn, C16_fn, CTT_fn, C01_fn, C02_fn, C03_fn]
